...
def display_food_database(food_database):
    for food in food_database:
        print(f"Name: {Fore.GREEN}{food['name']}{Style.RESET_ALL}")
...
def add_food_to_meal_log(food_database, meal_log):
    ...
    if food is not None:
        ...
        print(f"{food_name} added to {meal_type} in the meal log.")
    else:
...
def record_entry_to_calendar(calendar_entries, meal_log):
...
def main():
    ...
    while True:
        ...
        print("6. Create Food")
        print("7. Record Entry to Calendar")
        print("8. Exit")
        ...
        if choice == '1':
            ...
            record_entry_to_calendar(calendar_entries, meal_log)
        elif choice == '8':
